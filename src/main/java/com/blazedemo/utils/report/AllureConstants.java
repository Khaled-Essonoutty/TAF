...
public class AllureConstants {
    //Paths > final - static
    public static final Path USER_DIR = Paths.get(getPropertyValue("user.dir"), File.separator);
    public static final Path USER_HOME = Paths.get(getPropertyValue("user.home"), File.separator);
