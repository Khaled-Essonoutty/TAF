...
public class DownloadInvoiceTest extends BaseTest {
    ...
    {
        new PaymentPage(driver).downloadInvoice().verifyDownloadingInvoice("invoice.txt");
    }
    @Test(dependsOnMethods = {"registerNewAccountTC", "loginTC", "addProductToCartTC", "checkoutTC", "verifyPaymentTC","downloadInvoice"})
